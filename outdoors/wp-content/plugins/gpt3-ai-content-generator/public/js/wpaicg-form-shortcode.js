        ...
        if(wpaicgDownloadButtons && wpaicgDownloadButtons.length){
            for(var i=0; i < wpaicgDownloadButtons.length; i++) {
                ...
                wpaicgDownloadButton.addEventListener('click', function (e) {
                    ...
                    var isPro = wpaicgFormData.is_pro_plan || false;

                    // Convert to plain text by removing all HTML tags
                    var tmpDiv = document.createElement('div');
                    tmpDiv.innerHTML = currentContent;
                    var plainText = tmpDiv.innerText || tmpDiv.textContent || '';

                    // For free users: directly download as text without showing menu
                    if (!isPro) {
                    ...
                    // Pro users: Show the menu with PDF option
                    // Check if there's already a menu open
                    var existingMenu = document.getElementById('wpaicg-download-menu-' + formID);
                    if(!existingMenu) {
                        // Create a small pop-up menu container
                        var menuContainer = document.createElement('div');
                        menuContainer.id = 'wpaicg-download-menu-' + formID;
                        menuContainer.style.position = 'absolute';
                        menuContainer.style.background = '#fff';
                        menuContainer.style.border = '1px solid #ccc';
                        menuContainer.style.borderRadius = '4px';
                        menuContainer.style.boxShadow = '0 3px 6px rgba(0,0,0,0.1)';
                        menuContainer.style.padding = '5px 0';
                        menuContainer.style.zIndex = '999999';
                        menuContainer.style.cursor = 'pointer';

                        // Position below the button
                        menuContainer.style.top = (wpaicgDownloadButton.offsetTop + wpaicgDownloadButton.offsetHeight + 5) + 'px';
                        menuContainer.style.left = wpaicgDownloadButton.offsetLeft + 'px';
                        menuContainer.style.minWidth = '100px'; 
                        menuContainer.style.textAlign = 'left';

                        var pdfIconSVG = '<svg xmlns="http://www.w3.org/2000/svg" height="14" width="14" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#fa0000" d="M0 64C0 28.7 28.7 0 64 0L224 0l0 128c0 17.7 14.3 32 32 32l128 0 0 144-208 0c-35.3 0-64 28.7-64 64l0 144-48 0c-35.3 0-64-28.7-64-64L0 64zm384 64l-128 0L256 0 384 128zM176 352l32 0c30.9 0 56 25.1 56 56s-25.1 56-56 56l-16 0 0 32c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-48 0-80c0-8.8 7.2-16 16-16zm32 80c13.3 0 24-10.7 24-24s-10.7-24-24-24l-16 0 0 48 16 0zm96-80l32 0c26.5 0 48 21.5 48 48l0 64c0 26.5-21.5 48-48 48l-32 0c-8.8 0-16-7.2-16-16l0-128c0-8.8 7.2-16 16-16zm32 128c8.8 0 16-7.2 16-16l0-64c0-8.8-7.2-16-16-16l-16 0 0 96 16 0zm80-112c0-8.8 7.2-16 16-16l48 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-32 0 0 32 32 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-32 0 0 48c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-64 0-64z"/></svg>';

                        var textIconSVG = '<svg xmlns="http://www.w3.org/2000/svg" height="14" width="10.5" viewBox="0 0 384 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#74C0FC" d="M64 0C28.7 0 0 28.7 0 64L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-288-128 0c-17.7 0-32-14.3-32-32L224 0 64 0zM256 0l0 128 128 0L256 0zM112 256l160 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-160 0c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64l160 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-160 0c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64l160 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-160 0c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>';

                        // Menu item: TEXT
                        var textItem = document.createElement('div');
                        textItem.style.display = 'flex';
                        textItem.style.alignItems = 'center';
                        textItem.style.padding = '5px 10px';
                        textItem.style.borderBottom = '1px solid #eee';
                        textItem.style.fontSize = '14px';
                        textItem.innerHTML = textIconSVG + '<span style="margin-left:5px;">Text</span>';
                        ...
                        pdfItem.style.padding = '5px 10px';
                        pdfItem.style.fontSize = '14px';
                        pdfItem.innerHTML = pdfIconSVG + '<span style="margin-left:5px;">PDF</span>';
                        pdfItem.addEventListener('click', function() {
                            // Download as PDF
                            if (typeof window.jspdf === 'undefined' || !window.jspdf.jsPDF) {
                                alert('PDF library not loaded. Please ensure jsPDF is enqueued properly.');
                            } else {
                        ...
                        menuContainer.appendChild(textItem);
                        menuContainer.appendChild(pdfItem);

                        // Insert the menu in the same parent as the Download button
                        wpaicgDownloadButton.parentNode.appendChild(menuContainer);

                        // Hide menu if user clicks outside
                        var handleDocumentClick = function(event) {
                            // If the click is outside the menuContainer and not on the download button, remove it
                            if (!menuContainer.contains(event.target) && event.target !== wpaicgDownloadButton) {
                                menuContainer.remove();
                                document.removeEventListener('click', handleDocumentClick);
                            }
                        };
