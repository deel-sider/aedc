...
- Fixed an issue in WooCommerce Token Sale module.
...
- Addressed and fixed a security issue flagged by the Review Team.
- Fixed SQL issues.
...
- Improved chatbot responsiveness on mobile devices
- Added support for Google’s latest text-embedding-005 model

= 1.9.11 =

- Made KaTeX support for AI Forms optional to reduce page load times. KaTeX libraries (80KB) are now only loaded when needed. Disabled by default, can be enabled in **AI Forms > Setting** tab.
