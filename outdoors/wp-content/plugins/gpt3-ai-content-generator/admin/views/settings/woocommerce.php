    ...
    jQuery(document).ready(function($){
        ...
        function populateFocusKeywordTextArea() {
            ...
            var FocusKeywordTemplates = {
                '1': "<?php /* translators: %s: Product title. */ echo esc_js( esc_html__('Identify the primary keyword for the following product: %s. Please respond in English. No additional comments, just the keyword.', 'gpt3-ai-content-generator') ); ?>",
                '2': "<?php /* translators: %s: Product title. */ echo esc_js( esc_html__('Generate SEO-optimized and high-volume focus keywords in English for the following product: %s. Keywords should be the main terms you aim to rank for. Avoid using symbols like -, #, etc. Results must be comma-separated.', 'gpt3-ai-content-generator') ); ?>",
                '3': "<?php /* translators: %s: Product title. */ echo esc_js( esc_html__('Generate niche-specific and unique focus keywords in English for the product: %s. Keywords should closely align with the product unique features or niche. Avoid using symbols like -, #, etc. Results must be comma-separated.', 'gpt3-ai-content-generator') ); ?>",
                '4': "<?php /* translators: %s: Product title. */ echo esc_js( esc_html__('Generate trending or seasonally relevant focus keywords in English for the following product: %s. Ensure they directly relate to the product and its features. Avoid using symbols like -, #, etc. Results must be comma-separated.', 'gpt3-ai-content-generator') ); ?>",
                '5': "<?php /* translators: %s: Product title. */ echo esc_js( esc_html__('Generate focus keywords in English for the product: %s. Keywords should fill a gap or seize an opportunity that competitors might have missed but are still highly relevant to the product. Avoid using symbols like -, #, etc. Results must be comma-separated.', 'gpt3-ai-content-generator') ); ?>"
            };
